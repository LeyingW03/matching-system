...
def evaluate_price(p, lambda1, lambda2, q, gamma, termination_time,
    ...
    avg_revenue = total_revenue / eval_reps
    avg_revenue_rate = total_revenue_rate / eval_reps
...
if __name__ == "__main__":
    ...
    print("\n=== Golden section search for optimal price ===")
    p_star, pi_m_at_star, revenue_star, revenue_rate_star, history = golden_section_search(
        ...
        n_reps=n_reps, eval_reps=n_reps, verbose=True)
